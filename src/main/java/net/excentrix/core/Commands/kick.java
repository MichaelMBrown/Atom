                    ...
                    if (args.length > 0) {
                        ...
                        if (target != null) {
                            if (args.length > 1) {
                                ...
                                staffUtils.scNotif(sender.getName(), "kicked player " + ChatColor.GOLD + Array.get(args, 0) + ChatColor.YELLOW + " with reason: " + ChatColor.WHITE + reason);
                ...
                if (args.length > 0) {
                    ...
                    if (target != null) {
                        if (args.length > 1) {
                            ...
                            staffUtils.scNotif(ChatColor.RED + "Console", "kicked player " + ChatColor.GOLD + Array.get(args, 0) + ChatColor.YELLOW + " with reason: " + ChatColor.WHITE + ChatColor.translateAlternateColorCodes('&', reason));
                            target.kickPlayer(ChatColor.translateAlternateColorCodes('&', reason));
                        ...
                        if (args.length == 1) {
                            ...
                            staffUtils.scNotif("Console", "kicked player " + ChatColor.GOLD + Array.get(args, 0) + ChatColor.YELLOW + " with reason: " + ChatColor.WHITE + ChatColor.translateAlternateColorCodes('&', reason));
                            target.kickPlayer(ChatColor.translateAlternateColorCodes('&', reason));
                            plugin.getLogger().info(ChatColor.GREEN + sender.getName() + ChatColor.YELLOW + " kicked player " + ChatColor.GOLD + target.getName() + ChatColor.YELLOW + " with reason " + ChatColor.WHITE + ChatColor.translateAlternateColorCodes('&', reason));
                        }
                    } else {
