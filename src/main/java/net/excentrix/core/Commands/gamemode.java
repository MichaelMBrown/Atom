                ...
                if (args.length == 2) {
                    ...
                    if (target != null) {
                        if (args[0].equalsIgnoreCase("C") || args[0].equalsIgnoreCase("CREATIVE")) {
                            ...
                            staff_utils.scNotif(((Player) sender).getDisplayName(), "Set " + ChatColor.GOLD + target.getDisplayName() + ChatColor.YELLOW + "'s gamemode to " + ChatColor.GOLD + target.getGameMode() + ChatColor.YELLOW + ".");
                    ...
                    if (args[0].equalsIgnoreCase("C") || args[0].equalsIgnoreCase("CREATIVE")) {
                        ...
                        staff_utils.scNotif(((Player) sender).getDisplayName(), "Set own gamemode to " + ChatColor.GOLD + ((Player) sender).getGameMode() + ChatColor.YELLOW + ".");
                    } else if (args[0].equalsIgnoreCase("S") || args[0].equalsIgnoreCase("SURVIVAL")) {
                    ...
                    sender.sendMessage(ChatColor.YELLOW + "Usage: " + ChatColor.GOLD + "/gamemode " + ChatColor.WHITE + "<player> <gamemode>");
                }
            }
        }
        return true;
