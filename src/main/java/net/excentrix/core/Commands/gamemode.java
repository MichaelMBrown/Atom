                ...
                if (args.length == 2) {
                    ...
                    if (target != null) {
                        if (args[0].equalsIgnoreCase("C") || args[0].equalsIgnoreCase("CREATIVE")) {
                            ...
                            staff_utils.scNotif(((Player) sender).getDisplayName(), "Set " + target.getDisplayName() + "'s gamemode to " + target.getGameMode() + ".");
                    ...
                    if (args[0].equalsIgnoreCase("C") || args[0].equalsIgnoreCase("CREATIVE")) {
                        ...
                        staff_utils.scNotif(((Player) sender).getDisplayName(), "Set own gamemode to " + ((Player) sender).getGameMode());
                    } else if (args[0].equalsIgnoreCase("S") || args[0].equalsIgnoreCase("SURVIVAL")) {
